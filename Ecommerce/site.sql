...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 27 Avril 2017 à 13:28
...
CREATE TABLE `commande` (
  ...
  `etat` enum('en cours de traitement','envoy?','livr?') NOT NULL
...
ALTER TABLE `details_commande`
  ADD PRIMARY KEY (`id_details_commande`);/* PRIMARY KEY permet de relier les tables entre elles*/
