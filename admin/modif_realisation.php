...
<?php
    // Gestion des contenus, mise à jour d'une réalisation
    if(isset($_POST['realisation'])){ // par le nom du premier input
        ...
        header('location:../admin/realisation.php');// le header pour revenir à la liste des réalisations de l'utilisateur
        exit();
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="formation.php"><i class="fa fa-fw fa-edit"></i> Expériences</a>
                    </li>  
                    <li>
                        <a href="realisation.php"><i class="fa fa-fw fa-edit"></i> Réalisations</a>
                    </li>
                     <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Modification Réalisation(s)</h1>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Réalisations
                            </li>
                        </ol>
                    </div>
                </div>
 ...
 <div class="row">
    ...
    <legend style="text-align:center;"> Modification d'une réalisation</legend>

    <!-- Text input-->
    <div class="form-group">
      <label class="col-md-4 control-label" for="xp"></label>
      <div class="col-md-4">
      <input id="xp" name="realisation" type="text"  class="form-control input-md" value="<?php echo $ligne_realisation['realisation']; ?>">
